...
export declare namespace utils {
  const isPromise: typeof _isPromise;
  const buildReportMessage: typeof _buildReportMessage;
  const dateDiff: typeof _dateDiff;
  const deepEqual: typeof _deepEqual;
  const diff: typeof _diff;
  const executePromiseWithTimeout: typeof _executePromiseWithTimeout;
  const executeWithTimeout: typeof _executeWithTimeout;
  const formatObject: typeof _formatObject;
  const getStackTrace: typeof _getStackTrace;
  const isFunction: typeof _isFunction;
  const isNullOrUndefined: typeof _isNullOrUndefined;
  const isPrimitiveValue: typeof _isPrimitiveValue;
  const pick: typeof _pick;
  const resolveName: typeof _resolveName;
  const rgba: typeof _rgba;
  const stringIsNullOrEmpty: typeof _stringIsNullOrEmpty;
  const typeOf: typeof _typeOf;
  const wait: typeof _wait;
  const LogUpdate: typeof _logUpdate;
  const calcPermissionsValue: typeof _calcPermissionsValue;
  const isInDebugMode: typeof _isInDebugMode;
  const getFiles: typeof _getFiles;
}
